      ...
      try {
        ...
        const dbConnection: any = {
          ...
          columnMapping: {
            ...
            sessionIdColumn: appData.dataSource.config.columnMapping?.sessionIdColumn,
            contextColumn: appData.dataSource.config.columnMapping?.contextColumn,
            promptTimestampColumn: appData.dataSource.config.columnMapping?.promptTimestampColumn,
            contextRetrievalStartTimeColumn: appData.dataSource.config.columnMapping?.contextRetrievalStartTimeColumn,
            contextRetrievalEndTimeColumn: appData.dataSource.config.columnMapping?.contextRetrievalEndTimeColumn,
            llmRequestStartTimeColumn: appData.dataSource.config.columnMapping?.llmRequestStartTimeColumn,
            llmResponseEndTimeColumn: appData.dataSource.config.columnMapping?.llmResponseEndTimeColumn,
            contextChunkCountColumn: appData.dataSource.config.columnMapping?.contextChunkCountColumn,
            contextTotalLengthWordsColumn: appData.dataSource.config.columnMapping?.contextTotalLengthWordsColumn,
            promptLengthWordsColumn: appData.dataSource.config.columnMapping?.promptLengthWordsColumn,
            responseLengthWordsColumn: appData.dataSource.config.columnMapping?.responseLengthWordsColumn,
            statusColumn: appData.dataSource.config.columnMapping?.statusColumn,
          },
          isActive: true,
          createdAt: new Date(),
          updatedAt: new Date(),
